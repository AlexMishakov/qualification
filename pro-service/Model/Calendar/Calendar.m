...
- (void)loadFromDate:(NSDate *)date
{
    ...
    NSString *StrUrl = [NSString stringWithFormat:@"/event.get?date=%@", [dateFormatter stringFromDate:date]];
    StrUrl = [DOMEN stringByAppendingString: StrUrl];
    DLog(@"StrUrl: %@", StrUrl);
    NSData *data = [NSData dataWithContentsOfURL:[NSURL URLWithString:StrUrl]];
    NSError *error = nil;
...
{
    NSString *StrUrl = [NSString stringWithFormat:@"/event.get?tag=%@", [tags componentsJoinedByString:@","]];
    StrUrl = [DOMEN stringByAppendingString: StrUrl];
    DLog(@"StrUrl: %@", StrUrl);
    NSData *data = [NSData dataWithContentsOfURL:[NSURL URLWithString:StrUrl]];
    NSError *error = nil;
